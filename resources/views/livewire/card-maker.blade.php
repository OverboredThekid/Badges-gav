                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 col-sm-offset-1">
                                                <div class="picture-container">
                                                    <div class="picture">
                                                        ...
                                                        <input type="file" id="wizard-picture" wire:model="file">
                                                    </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="name" type="text" class="form-control" placeholder="Andrew Smith..." wire:model="name">
                                                </div>
                                                <div class="form-group">
                                                    <label>Phone Number<small>(required)</small></label>
                                                    <input name="phone" type="text" class="form-control" placeholder="123 456-7890" wire:model="number">
                                                </div>
                                            </div>
                                            <div class="col-sm-10 col-sm-offset-1">
                                                <div class="form-group">
                                                    <label>Email <small>(required)</small></label>
                                                    <input name="email" type="email" class="form-control" placeholder="andrew@creative-tim.com" wire:model="email">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
