                ...
                <div id="svg-card">
                    ...
                    <svg id="Layer_2" class='' xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 153.87 240.5">
                        ...
                        <g id="Back_ID">
                            ...
                            <image id="GAV_Small_Logo" width="681" height="228" transform="translate(2.61 190.46) rotate(-90) scale(.21)" xlink:href="assets/img/gav-small-white.png" />
                        </g>
                    </svg>
                    <svg id="Layer_2" class='' xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 155.52 232.23">
                        ...
                        <g id="Front_ID"><text class="back-4" transform="translate(27.7 227.98)">
                            ...
                            <image id="QR_Code_generationsav.com_stafflinks_" width="2255" height="2255" transform="translate(35.55 115.26) scale(.04)" xlink:href="assets/img/qr-code.png" />
                            ...
                            <image id="GAV_Big_Logo" width="1340" height="538" transform="translate(3.71 30.74) scale(.11)" xlink:href="assets/img/gav-big-white.png" />
                        </g>
                    </svg>
                </div>
                <div id='end-buttons'>
                    <button class="btn btn-info btn-lg pull-right" type="button" onclick="printpart()">Print</button>
